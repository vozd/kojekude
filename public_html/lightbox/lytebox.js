...
Lytebox.prototype.resizeContainer = function(iWidth, iHeight) {
	this.resizeWidth = this.doc.$('lbOverlay').offsetWidth;
...
Lytebox.prototype.setOptions = function(sOptions) {
	...
	case '.mov':
			...
			object 	= '<object classid="../Novi Sad 2011/' + classId + '" width="' + w + '" height="' + h + '" codebase="../Novi Sad 2011/' + codebase + '">'
					+ '<param name="src" value="../Novi Sad 2011/' + url + '">'
					+ '<param name="autoplay" value="' + auto + '">'
					+ '<param name="loop" value="' + loop + '">'
					+ '<param name="controller" value="true">'
					+ '<embed src="../Novi Sad 2011/' + url + '" width="' + w + '" height="' + h + '" autoplay="' + auto + '" loop="' + loop + '" controller="true" pluginspage="' + pluginsPage + '"></embed>'
					+ '</object>';
		...
		case '.wmv':
			...
			object 	= '<object classid="../Novi Sad 2011/' + classId + '" width="' + w + '" height="' + h + '" codebase="../Novi Sad 2011/' + codebase + '">'
					...
					+ '<param name="loop" value="' + loop + '">'
					+ '<param name="controller" value="true">'
					+ '<object type="video/quicktime" data="../Novi Sad 2011/' + url + '" width="' + w + '" height="' + h + '">'
		...
		case '.swf':
			...
			object 	= '<object classid="../Novi Sad 2011/' + classId + '" width="' + w + '" height="' + h + '" codebase="../Novi Sad 2011/' + codebase + '">'
					+ '<param name="movie" value="../Novi Sad 2011/' + url + '">'
					+ '<param name="quality" value="high">'
					+ '<param name="wmode" value="opaque">'
					+ '<!--[if !IE]>-->'
					+ '<object type="application/x-shockwave-flash" data="../Novi Sad 2011/' + url + '" width="' + w + '" height="' + h + '">'
					+ '<!--<![endif]-->'
					+ '<param name="quality" value="high">'
					+ '<param name="wmode" value="opaque">'
